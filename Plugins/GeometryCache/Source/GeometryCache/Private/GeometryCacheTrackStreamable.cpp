...
FGeometryCacheMeshData UGeometryCacheTrackStreamable::GetMeshSample(float Time)
{
	int32 SampleIndexToDecode = -1;
	FGeometryCacheMeshData MeshData;
	
	GetRenderResource()->UpdateMeshData(Time, true, SampleIndexToDecode, MeshData);
