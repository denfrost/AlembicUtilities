...
FGeometryCacheMeshData FCodecGeometryCachePreprocessor::GetMeshSample()
{
...
FGeometryCacheMeshData FOptimizeGeometryCachePreprocessor::GetMeshSample()
{
	if (NumFramesInBuffer == 64 || NumFramesInBuffer > 0)
	{
		FlushBufferedFrames();
	}
	return BufferedFrames[NumFramesInBuffer].MeshData;
}
...
FGeometryCacheMeshData FExplicitMotionVectorGeometryCachePreprocessor::GetMeshSample()
{
